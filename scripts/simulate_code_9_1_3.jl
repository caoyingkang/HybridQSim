...
# Plotting
f = Figure()
ax = Axis(f[1, 1], xlabel="Analog Evolution Time", ylabel="Fidelity", title="[[9,1,3]] Surface Code")
...
mkpath(figs_dir)
save(joinpath(figs_dir, "surface_code_9_1_3.png"), f)
display(f)
