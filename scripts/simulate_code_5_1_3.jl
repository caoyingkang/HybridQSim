...
ax = Axis(fig[1, 1:2], ylabel="Fidelity", title="[[5,1,3]] Code, Initial State |0⟩")
...
ax = Axis(fig[2, 1:2], ylabel="Fidelity", title="[[5,1,3]] Code, Initial State |+⟩")
...
ax = Axis(fig[3, 1:2], xlabel="Analog Evolution Time", ylabel="Fidelity", title="[[5,1,3]] Code, Initial State |+i⟩")
...
mkpath(figs_dir)
save(joinpath(figs_dir, "code_5_1_3.png"), fig)
